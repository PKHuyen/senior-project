...
#             st.sidebar.markdown("**Python Path:**")
#             st.sidebar.code("\n".join(sys.path))
...
#                     st.sidebar.warning(f"{name} file not found at: {path}")
#                 else:
#                     st.sidebar.success(f"{name} file found at: {path}")
...
def resolve_image_path(relative_path: str) -> str:
    ...
    if relative_path.startswith('..'):
        # Remove the '../' prefix and join with PROJECT_ROOT
